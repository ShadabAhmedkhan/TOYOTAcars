...
namespace Toyota_App
{
    ...
    /// </summary>
    public sealed partial class truck : Page
    {
        public truck()
        {
        ...
        private void tacom_Tapped(object sender, TappedRoutedEventArgs e)
        {
           this.Frame.Navigate(typeof(tacoma_page));
        }

        private void tundra_Tapped(object sender, TappedRoutedEventArgs e)
        {
            this.Frame.Navigate(typeof(tundra_page));
        }
